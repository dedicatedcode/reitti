...
public class ExternalUser extends User implements OidcUser {
    ...
    public ExternalUser(User user, OidcUser oidcUser) {
        super(user.getId(), user.getUsername(), user.getPassword(), user.getDisplayName(), user.getProfileUrl(), user.getExternalId(), user.getRole(), user.getUserType(), user.getVersion());
