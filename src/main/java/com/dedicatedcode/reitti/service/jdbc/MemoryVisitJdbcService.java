...
public class MemoryVisitJdbcService {
    ...
    public void save(User user, MemoryVisit memoryVisit, Long memoryBlockId, Long originalId) {
        String sql = """
            INSERT INTO memory_visits (id, user_id, original_id, memory_block_id, name, start_time, end_time, latitude_centroid, longitude_centroid)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            """;
