...
@Service
@Transactional
public class PreviewTripTransportModeJdbcService {

    private final JdbcTemplate jdbcTemplate;

    public PreviewTripTransportModeJdbcService(JdbcTemplate jdbcTemplate) {
    ...
    public Map<Long, List<TransportModeSegment>> findByTripIds(List<Long> tripIds) {
        ...
        String sql = "SELECT trip_id, offset_seconds, duration_in_seconds, transportation_mode, distance_meters FROM preview_trip_transport_modes WHERE trip_id IN (" + placeholders + ") ORDER BY trip_id, offset_seconds";
