...
import com.dedicatedcode.reitti.model.integration.ReittiRemoteInfo;
...
public class OwntracksIngestApiController {

    private static final Logger logger = LoggerFactory.getLogger(OwntracksIngestApiController.class);
    ...
    public OwntracksIngestApiController(UserJdbcService userJdbcService,
    ...
    public ResponseEntity<?> receiveOwntracksData(@RequestBody OwntracksLocationRequest request) {
        ...
        User user = this.userJdbcService.findByUsername(userDetails.getUsername())
