ALTER TABLE user_map_styles
    ADD COLUMN default_style BOOLEAN DEFAULT FALSE;

CREATE TEMP TABLE tmp_default_style_ids (id BIGINT, name TEXT);
...
WITH inserted AS (
  ...
  "metadata": {
    ...
    "openmaptiles:mapbox:owner": "dedicatedcode",
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        "fill-color": "rgba(221, 217, 217, 0.23)"
      }
    },
    {
      ...
      "paint": {
        "fill-color": "rgba(244, 243, 239, 0.34)"
      }
    },
    {
      "id": "landuse-cemetery",
    ...
    },
    {
      ...
      "paint": {
        "fill-color": "rgba(233, 233, 233, 0.4)"
      }
    },
    {
      "id": "landcover-wood",
      ...
      "paint": {
        ...
        "fill-color": "rgba(119, 133, 118, 0.23)",
        "fill-opacity": 1,
        "fill-outline-color": "rgba(26, 26, 26, 0)"
      },
      "layout": {
        "visibility": "visible"
      }
    ...
    },
    {
      ...
      "paint": {
        ...
        "fill-color": "rgba(230, 230, 230, 0.56)",
        "fill-opacity": 0.9,
    ...
    },
    {
      ...
      "paint": {
        "line-color": "rgba(193, 193, 193, 0.77)",
        "line-width": {
          "base": 1.4,
          "stops": [
            [
    ...
    },
    {
      ...
      "paint": {
        "line-color": "rgba(193, 193, 193, 0.68)",
        "line-dasharray": [
          0.2,
          8
        ],
    ...
    },
    {
      ...
      "paint": {
        "fill-extrusion-color": "rgba(214, 214, 214, 1)",
  ...
  "layers": [
    ...
    },
    {
      ...
      "paint": {
        ...
        "fill-color": "rgba(25, 176, 16, 0.23)",
        "fill-opacity": 1,
    ...
    },
    {
      ...
      "paint": {
        "fill-extrusion-color": "rgba(209, 209, 209, 1)",
        "fill-extrusion-height": {
          "property": "render_height",
          "type": "identity"
        },
