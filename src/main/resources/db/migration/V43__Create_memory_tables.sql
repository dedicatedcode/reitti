...
CREATE TABLE memory_block_visit (
    ...
    processed_visit_id BIGINT NOT NULL REFERENCES processed_visit(id) ON DELETE CASCADE
);

CREATE INDEX idx_memory_block_visit_processed_visit_id ON memory_block_visit(processed_visit_id);
