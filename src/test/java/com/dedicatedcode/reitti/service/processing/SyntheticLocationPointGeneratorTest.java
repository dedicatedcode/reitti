...
class SyntheticLocationPointGeneratorTest {
    ...
    void shouldGenerateSyntheticPointsForValidGap() {
        ...
        RawLocationPoint startPoint = new RawLocationPoint(
                1L, null, startTime, new GeoPoint(50.0, 8.0), 10.0, 100.0, false, false, false, false, 1L
        );
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.001, 8.001), 15.0, 105.0, false, false, false, false, 1L
        );
    ...
    void shouldInterpolateCoordinatesCorrectly() {
        ...
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.002, 8.002), 20.0, 110.0, false, false, false, false, 1L
        );
    ...
    void shouldInterpolateAccuracyAndElevation() {
        ...
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.001, 8.001), 20.0, 120.0, false, false, false, false, 1L
        );
    ...
    void shouldHandleNullAccuracyAndElevation() {
        ...
        RawLocationPoint startPoint = new RawLocationPoint(
                1L, null, startTime, new GeoPoint(50.0, 8.0), null, null, false, false, false, false, 1L
        );
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.001, 8.001), null, null, false, false, false, false, 1L
        );
    ...
    void shouldNotInterpolateWhenDistanceTooLarge() {
        ...
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.01, 8.01), 20.0, 110.0, false, false, false, false, 1L // ~1.4km apart
        );
    ...
    void shouldNotGeneratePointsForShortGaps() {
        ...
        RawLocationPoint endPoint = new RawLocationPoint(
                2L, null, endTime, new GeoPoint(50.0001, 8.0001), 15.0, 105.0, false, false, false, false, 1L
        );
